...
const AuthMiddleware = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!token)
        return next(new unauthorized_exception_1.UnauthorizedException('Authorization Token Missing', root_1.ErrorCodes.UNAUTHORIZED));
    try {
        ...
        if (!user)
            return next(new unauthorized_exception_1.UnauthorizedException('Invalid Token', root_1.ErrorCodes.UNAUTHORIZED));
        req.user = user;
        next();
    }
    catch (err) {
